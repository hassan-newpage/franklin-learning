...
async function submitForm(form) {
    ...
    const resp = await fetch(`https://admin.hlx.page/form/hassan-newpage/franklin-learning/main${form.dataset.action}.json`, {
        method: 'POST',
        cache: 'no-cache',
        headers: {
    ...
    console.log('%c [ resp ]-43', 'font-size:13px; background:pink; color:#bf2c9f;', resp)
    await resp.text();
    return payload;
...
export async function createForm(formURL) {
    ...
    console.log('%c [ rules ]-199', 'font-size:13px; background:pink; color:#bf2c9f;', rules)
